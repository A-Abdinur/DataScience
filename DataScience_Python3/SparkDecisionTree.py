...
rawData = sc.textFile("C:/Users/Abdi/Desktop/DataScience_Python3/PastHires.csv")
...
trainingData = csvData.map(createLabeledPoints) #transforming every input to numericals
...
model = DecisionTree.trainClassifier(trainingData, numClasses=2,
                                     categoricalFeaturesInfo={1:2, 3:4, 4:2, 5:2}, #dictionary for the number of categories for each field, continous range like yearsOfExperience are not stated
                                     impurity='gini', maxDepth=5, maxBins=32) #'gini' impurity method of measuring entropy
...
results = predictions.collect() #collect returns python object of our predictions
